  ...
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <h1 className="text-2xl sm:text-3xl font-bold text-blue-950">Therapies</h1>
        <Link
        ...
        <table className="min-w-[600px] sm:min-w-full w-full border-collapse">
          ...
          <tbody>
            {therapies.map((therapy) => (
              <tr key={therapy._id} className="border-t hover:bg-gray-50">
                <td className="p-2 sm:p-4 font-semibold">{therapy.mainTitle}</td>
                ...
                <td className="p-2 sm:p-4">{therapy.role}</td>
